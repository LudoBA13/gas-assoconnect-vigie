function getAlerts()
{
	...
	},
	{
		...
		"message": "La convention doit être renouvelée bientôt.",
	...
	},
	{
		...
		"message": "Habilitation régionale expire bientôt. ($3)",
...
{
	return "=VSTACK({\"Alerte\" \\ \"Code VIF\" \\ \"Nom\" \\ \"Message\" }; SORT(VSTACK(IF(\n  ISNA('Alert-CNESSansÉpicerie'!$A$2);\n  TOCOL(; 1);\n  LET(\n    data; FILTER('Alert-CNESSansÉpicerie'!$A$2:$Z; 'Alert-CNESSansÉpicerie'!$A$2:$A <> \"\");\n    HSTACK(\n      MAKEARRAY(ROWS(data); 1; LAMBDA(r; c; \"CNESSansÉpicerie\"));\n      CHOOSECOLS(data; 1; 2);\n      MAKEARRAY(ROWS(data); 1; LAMBDA(r; c; \"Reçoit des produits CNES mais n'est pas une épicerie sociale.\"))\n    )\n  )\n);\nIF(\n  ISNA('Alert-ColisSansFSE'!$A$2);\n  TOCOL(; 1);\n  LET(\n    data; FILTER('Alert-ColisSansFSE'!$A$2:$Z; 'Alert-ColisSansFSE'!$A$2:$A <> \"\");\n    HSTACK(\n      MAKEARRAY(ROWS(data); 1; LAMBDA(r; c; \"ColisSansFSE\"));\n      CHOOSECOLS(data; 1; 2);\n      MAKEARRAY(ROWS(data); 1; LAMBDA(r; c; \"Distribution de type '\" & INDEX(data; r; 3) & \"' mais ne reçoit pas de FSE+.\"))\n    )\n  )\n);\nIF(\n  ISNA('Alert-ConventionExpirée'!$A$2);\n  TOCOL(; 1);\n  LET(\n    data; FILTER('Alert-ConventionExpirée'!$A$2:$Z; 'Alert-ConventionExpirée'!$A$2:$A <> \"\");\n    HSTACK(\n      MAKEARRAY(ROWS(data); 1; LAMBDA(r; c; \"ConventionExpirée\"));\n      CHOOSECOLS(data; 1; 2);\n      MAKEARRAY(ROWS(data); 1; LAMBDA(r; c; \"La date de dernière signature de convention est antérieure à 5 ans.\"))\n    )\n  )\n);\nIF(\n  ISNA('Alert-HabilitationInvalide'!$A$2);\n  TOCOL(; 1);\n  LET(\n    data; FILTER('Alert-HabilitationInvalide'!$A$2:$Z; 'Alert-HabilitationInvalide'!$A$2:$A <> \"\");\n    HSTACK(\n      MAKEARRAY(ROWS(data); 1; LAMBDA(r; c; \"HabilitationInvalide\"));\n      CHOOSECOLS(data; 1; 2);\n      MAKEARRAY(ROWS(data); 1; LAMBDA(r; c; \"Absence d'habilitation valide.\"))\n    )\n  )\n);\nIF(\n  ISNA('Alert-HabilitationRégionaleExpirée'!$A$2);\n  TOCOL(; 1);\n  LET(\n    data; FILTER('Alert-HabilitationRégionaleExpirée'!$A$2:$Z; 'Alert-HabilitationRégionaleExpirée'!$A$2:$A <> \"\");\n    HSTACK(\n      MAKEARRAY(ROWS(data); 1; LAMBDA(r; c; \"HabilitationRégionaleExpirée\"));\n      CHOOSECOLS(data; 1; 2);\n      MAKEARRAY(ROWS(data); 1; LAMBDA(r; c; \"Habilitation régionale expirée.\"))\n    )\n  )\n);\nIF(\n  ISNA('Alert-HabilitationRégionaleIncohérente'!$A$2);\n  TOCOL(; 1);\n  LET(\n    data; FILTER('Alert-HabilitationRégionaleIncohérente'!$A$2:$Z; 'Alert-HabilitationRégionaleIncohérente'!$A$2:$A <> \"\");\n    HSTACK(\n      MAKEARRAY(ROWS(data); 1; LAMBDA(r; c; \"HabilitationRégionaleIncohérente\"));\n      CHOOSECOLS(data; 1; 2);\n      MAKEARRAY(ROWS(data); 1; LAMBDA(r; c; \"Habilitation régionale incohérente. Statut : '\" & INDEX(data; r; 3) & \"'. Date : '\" & INDEX(data; r; 4) & \"'.\"))\n    )\n  )\n);\nIF(\n  ISNA('Alert-RenouvelerConvention'!$A$2);\n  TOCOL(; 1);\n  LET(\n    data; FILTER('Alert-RenouvelerConvention'!$A$2:$Z; 'Alert-RenouvelerConvention'!$A$2:$A <> \"\");\n    HSTACK(\n      MAKEARRAY(ROWS(data); 1; LAMBDA(r; c; \"RenouvelerConvention\"));\n      CHOOSECOLS(data; 1; 2);\n      MAKEARRAY(ROWS(data); 1; LAMBDA(r; c; \"La convention doit être renouvelée bientôt.\"))\n    )\n  )\n);\nIF(\n  ISNA('Alert-RenouvelerHabilitationRégionale'!$A$2);\n  TOCOL(; 1);\n  LET(\n    data; FILTER('Alert-RenouvelerHabilitationRégionale'!$A$2:$Z; 'Alert-RenouvelerHabilitationRégionale'!$A$2:$A <> \"\");\n    HSTACK(\n      MAKEARRAY(ROWS(data); 1; LAMBDA(r; c; \"RenouvelerHabilitationRégionale\"));\n      CHOOSECOLS(data; 1; 2);\n      MAKEARRAY(ROWS(data); 1; LAMBDA(r; c; \"Habilitation régionale expire bientôt. (\" & INDEX(data; r; 3) & \")\"))\n    )\n  )\n);\nIF(\n  ISNA('Alert-SIRETInvalide'!$A$2);\n  TOCOL(; 1);\n  LET(\n    data; FILTER('Alert-SIRETInvalide'!$A$2:$Z; 'Alert-SIRETInvalide'!$A$2:$A <> \"\");\n    HSTACK(\n      MAKEARRAY(ROWS(data); 1; LAMBDA(r; c; \"SIRETInvalide\"));\n      CHOOSECOLS(data; 1; 2);\n      MAKEARRAY(ROWS(data); 1; LAMBDA(r; c; \"SIRET manquant ou invalide.\"))\n    )\n  )\n);\nIF(\n  ISNA('Alert-ÉpicerieFSE'!$A$2);\n  TOCOL(; 1);\n  LET(\n    data; FILTER('Alert-ÉpicerieFSE'!$A$2:$Z; 'Alert-ÉpicerieFSE'!$A$2:$A <> \"\");\n    HSTACK(\n      MAKEARRAY(ROWS(data); 1; LAMBDA(r; c; \"ÉpicerieFSE\"));\n      CHOOSECOLS(data; 1; 2);\n      MAKEARRAY(ROWS(data); 1; LAMBDA(r; c; \"Épicerie sociale mais reçoit des produits FSE+.\"))\n    )\n  )\n);\nIF(\n  ISNA('Alert-ÉquipementFraisManquant'!$A$2);\n  TOCOL(; 1);\n  LET(\n    data; FILTER('Alert-ÉquipementFraisManquant'!$A$2:$Z; 'Alert-ÉquipementFraisManquant'!$A$2:$A <> \"\");\n    HSTACK(\n      MAKEARRAY(ROWS(data); 1; LAMBDA(r; c; \"ÉquipementFraisManquant\"));\n      CHOOSECOLS(data; 1; 2);\n      MAKEARRAY(ROWS(data); 1; LAMBDA(r; c; \"Souhaite recevoir du frais sans stockage réfrigéré.\"))\n    )\n  )\n);\nIF(\n  ISNA('Alert-ÉquipementSurgeléManquant'!$A$2);\n  TOCOL(; 1);\n  LET(\n    data; FILTER('Alert-ÉquipementSurgeléManquant'!$A$2:$Z; 'Alert-ÉquipementSurgeléManquant'!$A$2:$A <> \"\");\n    HSTACK(\n      MAKEARRAY(ROWS(data); 1; LAMBDA(r; c; \"ÉquipementSurgeléManquant\"));\n      CHOOSECOLS(data; 1; 2);\n      MAKEARRAY(ROWS(data); 1; LAMBDA(r; c; \"Souhaite recevoir du surgelé sans stockage à température négative.\"))\n    )\n  )\n)); 3; TRUE; 1; TRUE))";
}
